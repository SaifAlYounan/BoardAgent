-- BoardAgent: reject absent required arguments at the managed OAuth registration boundary.
-- SQL NULL and missing JSON keys must not turn validation predicates into UNKNOWN.
-- Preserve the original function authority, locking, replay and normalized inserts.
