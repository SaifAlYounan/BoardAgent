-- BoardAgent: refuse missing scalar OAuth registration arguments before replay/insert.
-- Restore the explicit pg_temp-last namespace set by 0098 and reset by 0164.
-- Preserve the registration signature, owner, grants, locking and valid behavior.
